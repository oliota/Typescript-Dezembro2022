...
let professor1 = new Professor("Oliota", "Typescript", ["Tipagem de variaveis", "Tipagem de funções", "Orientação a objetos", "Abstração", "Encapsulamento", "Herança", "Polimorfismo"]);
